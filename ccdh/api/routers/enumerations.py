...
async def get_enumeration(name: str, value_only: bool = False) -> Response:
    ...
    #TODO:
    # 2. list(set(myList)) <-- something like this?
    # 1. might want to clean up some items as well; empty strings, trailing spaces
    # (1) might be the only issue. might be appearing to be duplicates due to whitespace.
    # trim() use
    if value_only:
