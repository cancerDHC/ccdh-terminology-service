...
@router.get('/{model_entity_attribute}',
...
async def get_enumeration(model_entity_attribute: str, value_only: bool = False) -> Response:
    ...
    enum = EnumDefinition(name=model_entity_attribute, description=f'Autogenerated Enumeration for {system} {entity} {attribute}')
